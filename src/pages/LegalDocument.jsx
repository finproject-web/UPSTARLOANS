      ...
      <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
            UP Start Loans <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">Services</span>
          </h1>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-br from-white via-gray-50 to-slate-50 rounded-3xl shadow-2xl p-12 mb-12 border border-gray-200 backdrop-blur-sm">
            ...
            <div className="space-y-8 text-gray-700 leading-relaxed">
              <div className="flex items-start bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 p-6 rounded-xl border-l-4 border-indigo-400 shadow-lg">
                ...
                <p className="text-lg leading-relaxed">UP Start Loans Services provides unsecured personal loans of up to <span className="font-bold text-2xl text-indigo-600 drop-shadow-lg">$25,000</span></p>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 mb-10 border border-gray-100">
            ...
            <div className="space-y-8 text-gray-700 leading-relaxed">
              <div className="bg-gradient-to-r from-blue-50 to-transparent p-6 rounded-xl border-l-4 border-blue-500">
                ...
                <p className="text-lg leading-relaxed">This document establishes comprehensive policies, terms, and conditions governing relationship between UP Start Loans Services ("the Company") and applicants/customers regarding Payment Protection Insurance (PPI), bank account verification processes, and loan transactions.</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-transparent p-6 rounded-xl border-l-4 border-purple-500">
                ...
                <p className="text-lg leading-relaxed">These terms and conditions apply to all applicants, borrowers, and customers of UP Start Loans Services, regardless of loan amount, purpose, or delivery method. By proceeding with any loan application, applicant acknowledges and agrees to be bound by these policies.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-indigo-50 to-white p-6 rounded-xl border border-indigo-200">
                  ...
                  <p className="leading-relaxed">Any individual or entity submitting a loan application to UP Start Loans Services for consideration.</p>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services utilizes comprehensive credit evaluation methodologies, including but not limited to FICO scores, credit history analysis, debt-to-income ratios, and payment history. Minimum credit score requirements vary based on loan amount, purpose, and other risk factors.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services maintains a strict policy that customers are not required to pay Payment Protection Insurance premiums, verification fees, or compliance costs from personal funds. All required costs are structured within the loan framework or facilitated through alternative means.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services strictly prohibits loan disbursement into bank accounts with negative balances, restrictions, freezes, or other limitations that would impede proper fund access or repayment processing.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services maintains comprehensive internal monitoring systems to detect fraud, ensure compliance, and identify policy violations. These procedures include automated monitoring, manual reviews, and periodic audits.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <div>
                ...
                <p>UP Start Loans Services maintains right to suspend, deny, or cancel loan applications at any stage for any lawful reason, including but not limited to fraud detection, policy violations, or changes in applicant circumstances.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services assumes no liability for application delays, denials, verification outcomes, or decisions resulting from underwriting processes, compliance reviews, or regulatory requirements.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="text-gray-600">
              <p><strong>Customer Obligation:</strong> Customers agree to indemnify, defend, and hold harmless UP Start Loans Services, its officers, directors, employees, and affiliates from any and all claims, losses, damages, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from or related to false information, misuse of funds, or violation of these terms and conditions.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div>
                ...
                <p>UP Start Loans Services reserves the right to modify, update, or amend these policies at any time to reflect changes in laws, regulations, business practices, or operational requirements.</p>
              </div>
              <div>
                ...
                <div className="ml-12 mt-6">
                  <label className="flex items-start p-6 rounded-xl cursor-pointer hover:bg-red-50 transition-colors duration-200 border-2 border-transparent hover:border-red-300">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg text-red-700">I understand that declining consent may result in application withdrawal or ineligibility for loan services through UP Start Loans Services.</p>
                    </div>
                  </label>
                </div>
              </div>
