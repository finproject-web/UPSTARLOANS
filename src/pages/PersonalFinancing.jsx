...
Terms of Service: www.upstarsloans.com/terms-of-service`
    ...
    a.href = url
    a.download = `loan-info-${formData.firstName}-${formData.lastName}.txt`
          ...
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div className="border-t pt-4">
              ...
              <ol className="list-decimal list-inside space-y-1 ml-4">
                <li>The borrower acknowledges that UpStart Loans is a direct lender providing loan services.</li>
